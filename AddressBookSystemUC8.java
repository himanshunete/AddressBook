...
public class AddressBookSystemUC8 implements IContactDetails {
   ...
   public static void main(String[] args){
      ...
      AddressBookSystemUC8 cricketersDetails = new  AddressBookSystemUC8() ;
      AddressBookSystemUC8 footballersDetails =new  AddressBookSystemUC8() ;
      AddressBookSystemUC8 hockeyplayersDetails =new  AddressBookSystemUC8() ;
      AddressBookSystemUC8 basketballplayersDetails =new  AddressBookSystemUC8() ;
      ...
      for (int i=0; i<2 ; i++){
         ...
         footballersDetails.addDetails( addressBook, firstName, lastName,  address,  city , state,  zip, phoneNumber1, phoneNumber2 ,  email );
      }
